...
const Leaderboard = (props) => {
  ...
  return (
    <div className="leaderboard-container">
      <Helmet>
        <title>Leaderboard - Regular Immaterial Pheasant</title>
        <meta
          property="og:title"
            ...
            <div className="leaderboard-icon-group1">
              ...
              >
                <svg
                  ...
                  className="leaderboard-icon10 socialIcons"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="leaderboard-link1"
              >
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="leaderboard-icon12 socialIcons"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="leaderboard-link2"
              >
                <svg
                  viewBox="0 0 602.2582857142856 1024"
                  className="leaderboard-icon14 socialIcons"
                >
